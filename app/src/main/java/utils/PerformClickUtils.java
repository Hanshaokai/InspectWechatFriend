...
public class PerformClickUtils {
    ...
    public static void findTextAndClick(AccessibilityService accessibilityService, String text) {
        ...
        if (nodeInfoList != null && !nodeInfoList.isEmpty()) {
            ...
            for (AccessibilityNodeInfo nodeInfo : nodeInfoList) {
                if (nodeInfo != null && (text.equals(nodeInfo.getText()) || text.equals(nodeInfo
     ...
     * 检查viewId 进行点击
     */
public  static void findViewIdAnClick(AccessibilityService accessibilityService,String  id){
